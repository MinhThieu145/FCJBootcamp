...
Trong phần trước, sau khi thiết kế xong CI/CD pipeline thì mình đã tiếp tục với AWS Batch. Trong phần này, mình sẽ đi qua từng bước để thiết kế AWS Batch bằng CDK, bao gồm

- Tạo role cho Batch. Trong AWS Batch console có 1 khung là Execution role. Mình cần tạo và gán role này cho Batch
- Thiết kế hạ tầng mạng VPC cho Batch 
- Tạo Security Group cho Batch
- Tạo các components còn lại cho Batch: Compute Env, Job Definition, Job Queue,...
- Tạo EventBridge để có thể Schedule cho Batch chạy theo lịch trình

Nếu bạn thắc mắc tại sao không có Bucket. Thì trong workshop này mình đã tạo bucket thủ công. Lý do là vì việc pass tên bucket vào script crawler khá khó khăn do cách mình viết script. Do đó mình sẽ phải tạo 1 Bucket, pass tên bucket vào script crawler, sau đó mới có thể chạy crawler.
